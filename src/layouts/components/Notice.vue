...
const { unreadMsg, msgData } = storeToRefs(notificationStore)
const { setMsgData } = notificationStore

const isNoticeVisible = ref(false)

function onPopupVisibleChange(visible: boolean, context) {
